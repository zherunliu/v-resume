...
const getLocalStorageResume = () => {
  ...
  if (resumeStr) {
    ...
    personalExperienceList.value = resume.personalExperienceList
  }
}
  ...
  <div class="flex w-dvw flex-col items-center">
    ...
    <Base>
      <template v-if="isChanging" v-slot:header>
        <input
          :value="eduExperienceList.header"
          @change="
            (e: Event) => {
              eduExperienceList.header = (e.target as HTMLInputElement).value
            }
          "
